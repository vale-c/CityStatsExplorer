      ...
      <blockquote className="blockquote text-center" style={bqStyle}>
        <footer className="blockquote-footer">
          <div className="footer-description1">
            <span className="footer-name-text">Valentina Calabrese | </span>
          ...
          <div className="footer-description2">
            ...
            <img
              src={teleport_logo}
              className="teleport-logo animated infinite pulse delay-2s"
              alt="Teleport Logo"
            />
            <a
          ...
          <div className="footer-social-media">
            <a
              href="http://valentinacalabrese.com"
              style={aStyle}
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              <i
                id="social-link"
                className="far fa-window-maximize fa-2x social"
                aria-hidden="true"
              ></i>
            </a>
            <a
            ...
            >
              <i
                id="social-link"
                className="fab fa-github-square fa-2x social"
                aria-hidden="true"
              ></i>
            </a>
            <a
              href="https://linkedin.com/in/calabresevalentina"
              style={aStyle}
              target="_blank"
              rel="noopener noreferrer"
              className="social_links"
            >
              <i
                id="social-link"
                className="fab fa-linkedin fa-2x social"
                aria-hidden="true"
              ></i>
            </a>
            <a
